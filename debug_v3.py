...
from weights import StabilityScore_v3
...
BETA_OVERRIDE = None            # e.g. 0.9
THETA_OVERRIDE = None           # e.g. 0.7
...
def main() -> None:
    ...
    result = StabilityScore_v3.StabilityScore(NPZ_PATH, **ss_kwargs).compute()
    ...
    tag = f"{meta['dataset']}_{meta['model']}_E{E}_w{window_used}_p{P0:.2f}_tau{TAU:.2f}_v3"
    _ensure_dir(OUT_DIR)

    reached_ratio = float(np.mean(a_max >= result.theta))
    ...
    print(f"EMA beta={result.beta:.4f}, theta={result.theta:.4f}, has_reach_ema={reached_ratio * 100:.2f}%")
    ...
    # Additional stats for v3
    print("\n=== Stats: v3 stability diagnostics ===")
    _print_stats("S_raw [all]", _describe(S_raw))
    _print_stats("S_norm [all]", _describe(S))
    _print_stats("t_anchor [all]", _describe(t_anchor))
    _print_stats("L [all]", _describe(L))
    ...
    _save_hist(
        ...
        out_path=OUT_DIR / f"{tag}__v3__score_all.png",
        bins=40,
    )
    _save_hist(
        L,
        ...
        xlabel="L_i",
        out_path=OUT_DIR / f"{tag}__v3__L_all.png",
        bins=60,
    )
    _save_hist(
        S_raw,
        ...
        xlabel="S_raw",
        out_path=OUT_DIR / f"{tag}__v3__S_raw_all.png",
        bins=40,
    ...
    _save_hist(
        ...
        xlabel="S_norm",
        out_path=OUT_DIR / f"{tag}__v3__S_all.png",
        bins=40,
    ...
    _save_hist(
        a_max,
        title=f"EMA a_max distribution ({tag})",
        xlabel="a_max",
        out_path=OUT_DIR / f"{tag}__v3__a_max_all.png",
        bins=40,
        vlines=[(result.theta, f"theta={result.theta:.2f}")],
    )
    _save_hist(
        t_anchor,
        title=f"t_anchor distribution ({tag})",
        xlabel="t_anchor (0-index)",
        out_path=OUT_DIR / f"{tag}__v3__t_anchor_all.png",
        bins=60,
    )
    ...
    _save_hist(
        ...
        xlabel="StabilityScore",
        out_path=OUT_DIR / f"{tag}__v3__score_learnable.png",
        bins=40,
    )
    _save_hist(
        score_non,
        ...
        xlabel="StabilityScore",
        out_path=OUT_DIR / f"{tag}__v3__score_nonlearnable.png",
        bins=40,
    )
    _save_hist(
        L_learn,
        ...
        xlabel="L_i",
        out_path=OUT_DIR / f"{tag}__v3__L_learnable.png",
        bins=40,
    )
    _save_hist(
        L_non,
        ...
        xlabel="L_i",
        out_path=OUT_DIR / f"{tag}__v3__L_nonlearnable.png",
        bins=40,
    )
    _save_hist(
        S_learn,
        ...
        xlabel="S_norm",
        out_path=OUT_DIR / f"{tag}__v3__S_learnable.png",
        bins=40,
    )
    _save_hist(
        S_non,
        ...
        xlabel="S_norm",
        out_path=OUT_DIR / f"{tag}__v3__S_nonlearnable.png",
        bins=40,
    )
    ...
    _save_hist(
        ...
        xlabel="M_i",
        out_path=OUT_DIR / f"{tag}__v3__M_all.png",
        bins=40,
    ...
    _save_hist(
        ...
        xlabel="I_i",
        out_path=OUT_DIR / f"{tag}__v3__I_all.png",
        bins=40,
        vlines=[(0.5, "0.5")],
    )
    _save_hist(
        ...
        xlabel="M_i",
        out_path=OUT_DIR / f"{tag}__v3__M_nonlearnable.png",
        bins=40,
        vlines=[(P0, f"p0={P0:.2f}")],
    )
    ...
    _save_scatter(
        ...
        xlabel="L_i",
        ylabel="S_norm",
        out_path=OUT_DIR / f"{tag}__v3__scatter_LS_learnable.png",
    )
    # All-samples scatter
    _save_scatter(
        L,
        ...
        xlabel="L_i",
        ylabel="S_norm",
        out_path=OUT_DIR / f"{tag}__v3__scatter_LS_all.png",
    )
