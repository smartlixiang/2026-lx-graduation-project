...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mean-linear-a", type=float, default=None)
...
def main() -> None:
    ...
    linear_a, linear_b = resolve_dataset_linear_params(args.dataset, args.mean_linear_a, args.mean_linear_b)
    ...
    for kr in tqdm(keep_ratios, desc="KR loop", unit="kr"):
        ...
        mean_scale = mean_scale_from_linear(linear_a, linear_b, kr)
    ...
    save_mean_scale_curve(args.dataset, keep_ratios, linear_a, linear_b, output_dir)
